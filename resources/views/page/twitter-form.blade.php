...
<style type="text/css">
	...
	#form-body{
		border-top:6px solid #00aced !important;
	}
</style>
@endpush
...
<form method="post" action="{{URL::current()}}" class="ui form" enctype="multipart/form-data">
	<div class="ui segments" style="margin-top:0" id="form">
		<div class="ui segment" id="form-body">
			<h4 class="ui dividing header" style="padding-bottom:10px;">
				<i class="pencil square icon"></i>
				<div class="content">Compose new Tweet</div>
			</h4>
			<div class="field">
				<textarea name="message" rows="3" placeholder="Your Tweet here"></textarea>
			</div>
			...
			<div class="ui borderless menu">
				...
				<div class="right menu">
					<div class="item" style="padding-right: 10px;">
						<button class="ui twitter icon button" id="post"><i class="twitter square icon"></i> Tweet</button>
					</div>
				</div>
			</div>
		</div>
